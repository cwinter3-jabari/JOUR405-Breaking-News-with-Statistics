...
This data is skewed in one direction. The average of car stolen in a January is 12 cars, which means that 8 - 16 cars were stolen in the first 31 days of the New Year. The data skews right which could imply that there are certain days where the most amount of cars are stolen.
